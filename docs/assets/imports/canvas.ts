...
export function renderScene(ctx: any, scene: Scene) {
...
export function renderGameOver(ctx: any) {
...
export function checkCollision(a: any, b: any) {
...
function drawText(ctx: any, text: string, x: number, y: number, fillStyle: string,
